---
title: "Visualization of Demestic flight delay in May 2017"
author: "Zeping He"
...
popuplabels <- paste(finished$DISPLAY_AIRPORT_NAME,"Airport",
                 "<br>Average Delay Here is</br>",round(finished$DEP_DELAY_NEW),"minutes","<br>Passager Traffic Here is</br>",finished$Flow)
...
popuplabels2 <- paste(a$DISPLAY_AIRPORT_NAME,"Airport",
                 "<br>Average Delay Here is</br>",round(a$DEP_DELAY_NEW),"minutes","<br>Passager Traffic Here is</br>",a$Flow)
...
popuplabels3 <- paste(a$DISPLAY_AIRPORT_NAME,"Airport",
                 "<br>Average Delay Here is</br>",round(a$DEP_DELAY_NEW),"minutes","<br>Passager Traffic Here is</br>",a1$Flow)
 ...
 **Plot Relationship between Passager flow and Punctuality rate**
 After visualization the average delay of each airport, I want to study the relationship between Punctuality and passager traffic. Punctuality rate is different from average delay time, because this time we don't need to classify value by mean. Instead, we only need to know the ratio between 'flights departure delay less than 15 minutes' and the total scheduled flight for each airport.
...
## Relationship between Passager flow and Punctuality rate {.tabset}
...
figure() %>% ly_points(Flow,On_time_Rate,data=g2a, hover=Description,color =g2a$On_time_Rate ) %>% 
  ...
  ly_abline(h=mean(g2a$On_time_Rate), color = "red",  width =1, alpha=.7)
...
ggscatter(g2a50, y = "On_time_Rate", x = "Flow", 
          ...
          ylab = "On_time_Rate", xlab = "Passager Flow")
```
...
The radius of each circle represent the half-year numberic passager traffic of each airport.
```{r, warning=F,message=F}
##The radius of each circle represent the half-year numberic passager traffic of each airport.
#radius = ~sqrt(finished$Flow)*0.01
m2
